...
export default function Pages() {
  return (
    <div className="container mx-auto p-4 sm:p-6 md:p-10">
      ...
      <div className="flex flex-col sm:flex-col md:flex-row items-center bg-gray-100 p-4 sm:p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
        {/* Product Image */}
        <div className="w-full md:w-1/2">
          <Image
            src="/images/Pink.png"
        ...
        <div className="w-full md:w-1/2 md:ml-6 mt-4 md:mt-0">
          ...
          {/* Price */}
          <p className="text-lg font-semibold mb-4 text-white bg-teal-600 w-20 rounded-full flex items-center justify-center">
            $99.99
          </p>
          <p className="text-gray-600 mb-4 border-t-2 mt-2 pt-4">
            This stylish and durable library stool chair is perfect for your
      ...
      <div className="w-full">
        <div className="bg-[#FFFFFF] py-8 w-full h-auto">
          {/* Title and View All on Same Line */}
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl sm:text-2xl font-inter font-bold">
              Featured Products
            </h2>
            <p className="text-right text-black border-b-2 border-black hover:underline cursor-pointer">
              View all
          ...
          <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <div className="relative w-full h-[377px] p-4 rounded-lg shadow-sm">
              ...
              />
              <div className="flex gap-6 items-center">
                <h3 className="text-sm font-medium font-inter text-gray-500">
                  Library Stool Chair
                </h3>
                <p className="text-black mr-14">$20</p>
              </div>
