    ...
    <div className="bg-white py-8 w-full h-[650px] ">
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="relative group overflow-hidden  rounded-lg  shadow-lg">
          <Image src="/images/library.png" alt="Wing Chair" width={500} height={500} className="w-[424px] h-[424px] object-cover group-hover:opacity-75  " />
        ...
        {/* Wooden Chair */}
        <div className="relative group overflow-hidden  rounded-lg shadow-lg">
          <Image src="/images/wooden.png" alt="Wooden Chair"width={500} height={500} className="w-[424px] h-[424px] object-cover group-hover:opacity-75   "/>
          <div className="absolute bottom-0 left-0 right-0  px-4 py-3 font-inter   bg-gradient-to-t from-black to-transparent" >
        ...
        {/* Desk Chair */}
        <div className="relative group overflow-hidden  rounded-lg shadow-lg">
          <Image src="/images/Desk.png" alt="Desk Chair"  width={500} height={500} className="w-[424px] h-[424px] object-cover group-hover:opacity-75  "/>
          <div className="absolute bottom-0 left-0 right-0 px-4 py-3 font-inter  bg-gradient-to-t from-black to-transparent ">
