...
export default function Product() {
  ...
  return (
    <div className="w-full bg-white">
      {/* Logo Section */}
      <div className="h-[139px] flex justify-center items-center py-4 gap-10 sm:gap-16 md:gap-20 lg:gap-28">
        {/* Show First 3 Logos on sm (640px), Show All on md and lg */}
        <Image src="/images/Logo1.png" alt="Zapier" width={85} height={87} className="w-[85px] h-[87px] object-contain" />
        <Image src="/images/Logo2.png" alt="Pipedrive" width={107} height={109} className="w-[107px] h-[109px] object-contain" />
        <Image src="/images/Logo3.png" alt="CIB Bank" width={135} height={139} className="w-[135px] h-[139px] object-contain" />
        <Image src="/images/Logo4.png" alt="Logo4" width={63} height={65} className="w-[63px] h-[65px] object-contain hidden sm:block" />
        <Image src="/images/Logo5.png" alt="Burnt Toast" width={98} height={65} className="w-[98px] h-[101px] object-contain hidden sm:block" />
        <Image src="/images/Logo6.png" alt="PandaDoc" width={113} height={115} className="w-[113px] h-[115px] object-contain hidden sm:block" />
        <Image src="/images/Logo7.png" alt="Moz" width={84} height={87} className="w-[84px] h-[87px] object-contain hidden sm:block" />
      </div>
