...
//               <h3 className="text-md font-medium font-inter text-[#029FAE]">Library Stool Chair</h3>
//               <BsCartDash className="w-6 h-6 rounded-sm bg-[#029FAE] text-white mr-10 " />
//             </div>
...
//             />
//             <div className="flex justify-between items-center">
//               <h3 className="text-md font-medium font-inter">Library Stool Chair</h3>
//               <BsCartDash className="w-6 h-6 rounded-sm text-gray-500 mr-10" />
//             </div>
//             <p className="text-gray-700">$20</p>
//           </div>
