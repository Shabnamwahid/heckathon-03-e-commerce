  ...
  return (
    <div>
      <footer className="bg-gray-100 py-8">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className='flex items-center space-x-2'>
              <Image src="/images/LogoIcon.png" alt="sofa" width={30} height={30} />
              <h3 className="text-lg font-bold font-inter text-black">Comforty</h3>
            </div>
            <p className="text-gray-600 mt-4 font-inter">
            ...
            <div>
              <div className="flex space-x-4 mt-4">
                <FaFacebook className="text-teal-600 w-6 h-6 hover:text-gray-700" />
                <FaTwitter className="text-teal-600 w-6 h-6 hover:text-gray-700" />
                <FaInstagram className="text-teal-600 w-6 h-6 hover:text-gray-700" />
                <FaPinterest className="text-teal-600 w-6 h-6 hover:text-gray-700" />
                <FaYoutube className="text-teal-600 w-6 h-6 hover:text-gray-700" />
              </div>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold font-inter text-gray-800">Category</h4>
            <ul className="mt-4 space-y-2 font-inter">
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Sofa</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Armchair</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Wing Chair</Link></li>
              <li><Link href="#" className="text-teal-600 hover:text-gray-600">Desk Chair</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Wooden Chair</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Park Bench</Link></li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold text-gray-800 font-inter">Support</h4>
            <ul className="mt-4 space-y-2 font-inter">
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Help & Support</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Terms & Conditions</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Privacy Policy</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-teal-600">Help</Link></li>
            </ul>
          </div>
        ...
        {/* Bottom Section */}
        <div className="border-t mt-8 pt-4">
          <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between text-gray-600 text-sm">
            <p className="text-center">© 2023 - Blogy - Designed & Developed by Zahirsoft</p>
