...
//   )
// }
// export default OurProducts'use client';
'use client';
  ...
  return (
    <div className='w-full'>
      <div className="bg-[#FFFFFF] py-8 w-full h-auto">
        <h2 className="text-center text-2xl font-inter font-bold mb-6 mt-8">Our Products</h2>
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 overflow-hidden">
          
          {/* Product 1 */}
          <div className="relative w-[312px] h-[377px] p-4 rounded-lg shadow-sm">
            <span className="absolute top-0 left-0 text-xs font-semibold px-2 py-1 rounded text-white bg-green-500">
              New
            </span>
            <Image
              src="/images/White.png"
          ...
          {/* Product 2 */}
          <div className="relative w-[312px] h-[377px] p-4 rounded-lg shadow-sm">
            <span className="absolute top-0 left-0 text-xs font-semibold px-2 py-1 rounded text-white bg-red-500">
              Sale
            </span>
            <Image
              src="/images/Pink.png"
